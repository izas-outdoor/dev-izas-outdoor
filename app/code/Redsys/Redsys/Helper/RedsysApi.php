...
class RedsysApi extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    private $moduleComment = "Pasarela Unificada de Redsys para Magento";
    
    public function __construct(){
        $vars_pay=array();
        $this->moduleVersion = \Magento\Framework\App\ObjectManager::getInstance()->get('\Magento\Framework\Module\ResourceInterface')->getDbVersion('Redsys_Redsys');
    }
    ...
    public function createMerchantSignature($key, $logActivo){
    ...
    public function createMerchantSignatureNotif($key, $datos, $logActivo){
        // Se decodifica la clave Base64
        $key = $this->decodeBase64($key);
        // Se decodifican los datos Base64
        $decodec = $this->base64_url_decode($datos);
