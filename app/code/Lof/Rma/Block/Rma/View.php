...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    public function getPrintUrl(){
        return $this->_urlBuilder->getUrl('rma/rma/print',
    ...
    public function isShowShippingConfirm()
    {
        $dontShowShippingConfirmationButton = [
            \Lof\Rma\Api\Data\StatusInterface::PACKAGE_SENT,
            \Lof\Rma\Api\Data\StatusInterface::REJECTED,
            \Lof\Rma\Api\Data\StatusInterface::CLOSED,
        ];
        $rma = $this->getRma();
        $status =  $this->status->load($rma->getStatusId());
    ...
    {
        return $this->_urlBuilder->getUrl(
            'rma/rma/savemessage', ['id' => $this->getRma(), 'shipping_confirmation' => true]
        );
    }
}
