    ...
    \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ( $this->isImport() ) {
            ...
            $this->buttonList->update('save', 'label', __('Import Category'));
        }
    }
    ...
    {
        if ( $this->_registry->registry('current_category')->getId() ) {
            return __("Edit Category '%1'", $this->escapeHtml($this->_registry->registry('current_category')->getData('name')));
