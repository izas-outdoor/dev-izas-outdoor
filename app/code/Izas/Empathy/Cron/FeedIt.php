    ...
    */
	...
	public function execute()
	{
        try {
            ...
            //Actualización feed IT
            $langId = '?pivots=lang&lang=it';
            ...
            $xmlStrIT = file_get_contents('https://www.izas-outdoor.com/amfeed/feed/download?id=14&file=empathy-it.xml.xml'); // read file to string
    
            //Set CURLOPT_POST to true to send a POST request.
            curl_setopt($this->curl, CURLOPT_POST, true);

            //Attach the XML string to the body of our request.
            curl_setopt($this->curl, CURLOPT_POSTFIELDS, $xmlStrIT);
