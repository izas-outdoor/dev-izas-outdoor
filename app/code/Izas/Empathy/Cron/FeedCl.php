    ...
    */
	...
	public function execute()
	{
        try {
            ...
            //Actualización feed CH
            $langId = '?pivots=lang&lang=es-cl';
            ...
            $xmlStrCH = file_get_contents('https://www.izas-outdoor.com/amfeed/feed/download?id=17&file=empathy-CH.xml.xml'); // read file to string
    
            //Set CURLOPT_POST to true to send a POST request.
            curl_setopt($this->curl, CURLOPT_POST, true);

            //Attach the XML string to the body of our request.
            curl_setopt($this->curl, CURLOPT_POSTFIELDS, $xmlStrCH);
