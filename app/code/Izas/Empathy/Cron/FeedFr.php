    ...
    */
	...
	public function execute()
	{
        try {
            ...
            //Actualización feed FR
            $langId = '?pivots=lang&lang=fr';
            ...
            $xmlStrFR = file_get_contents('https://www.izas-outdoor.com/amfeed/feed/download?id=16&file=empathy-FR.xml.xml'); // read file to string
            ...
            curl_setopt($this->curl, CURLOPT_POSTFIELDS, $xmlStrFR);
