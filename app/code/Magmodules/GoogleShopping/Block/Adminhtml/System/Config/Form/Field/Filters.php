...
class Filters extends AbstractFieldArray
{
    ...
    /**
     * @var \Magmodules\GoogleShopping\Block\Adminhtml\System\Config\Form\Field\Renderer\ProductTypes
     */
        ...
        try {
            if (!$this->productTypeRenderer) {
                $this->productTypeRenderer = $this->getLayout()->createBlock(
                    '\Magmodules\GoogleShopping\Block\Adminhtml\System\Config\Form\Field\Renderer\ProductTypes',
                    '',
                    ['data' => ['is_render_to_js_template' => true]]
                );
            }
