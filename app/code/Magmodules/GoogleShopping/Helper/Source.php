...
class Source extends AbstractHelper
{
    ...
    const XPATH_GROUPED_PARENT_ATTS = 'magmodules_googleshopping/types/grouped_parrent_atts';
    ...
    public function getAttributes($type, $filters = [])
    {
        ...
        //$prod = $productRepository->get($this->generalHelper->getStoreValue(self::XPATH_ID));
