 ...
 */
class OptionResolution extends AbstractFieldArray
{
    /**
     * Rows cache
     *
    ...
    protected $_template = 'WebPanda_Rma::system/config/form/field/array.phtml';
