...
class Url implements RowCustomizerInterface
{
    ...
    public function addData($dataRow, $productId)
    {
        ...
        if(!empty($dataRow['size'])){
            $addSizeValue = $dataRow['size'];
            if(is_string($addSizeValue)) $addSizeValue = str_replace(' ','-',strtolower($addSizeValue));
            $addPreSelected['size'] = $addSizeValue;
        }
        if(!empty($dataRow['color'])){
            $addColorValue = $dataRow['color'];
            if(is_string($addColorValue)) $addColorValue = str_replace(' ','-',strtolower($addColorValue));
            $addPreSelected['color'] = $addColorValue;
        }
        //qdq
        ...
        if ($this->urlRewrites && isset($this->urlRewrites[$productId])) {
            ...
            $routeParamsShort = [
                ...
                '_nosid' => true,
                '_query' => array_merge((array)$this->export->getUtmParams(), ['___store' => null],$addPreSelected),
