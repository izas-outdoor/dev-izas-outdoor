...
*/
namespace Bizum\Bizum\Controller;

use Bizum\Bizum\Model\BizumModel;
use Magento\Store\Model\StoreManagerInterface;
use Bizum\Bizum\Helper\RedsysApi;
use Magento\Framework\Data\Form\FormKey;

class BizumController extends \Magento\Framework\App\Action\Action
{
	protected $_baseURL;
    protected $_entorno;
    protected $_nombre;
    ...
    public function __construct(BizumModel $model, StoreManagerInterface $storeManager, FormKey $formKey) {
	...
	public function generaCamposFormulario($orderId, $productos, $amount, $cliente){
		$res=array();
		$urlTienda=$this->_baseURL."bizum/checkout/notify?form_key=" . $this->_formKey->getFormKey();
		$idioma_tpv="0";
		$moneda="978";
		$entorno="";
		...
		$miObj->setParameter("DS_MERCHANT_TRANSACTIONTYPE", 0); // El tipo de transacción siempre debe ser 0.
		...
		$miObj->setParameter("Ds_Merchant_Module","m2_bizum_3.2.0");
    ...
    {
    	die(Bizum\Bizum\Helper\Hmac::hash_hmac("sha256", "asdf", "123456"));
    }
}