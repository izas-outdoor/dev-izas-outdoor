...
class Base(models.AbstractModel):
    ...
    def with_delay(
        ...
        allow_queue_job_dev = bool(
            self.env['ir.config_parameter'].sudo().get_param('queue_job.default_allow_queue_job_dev'))
        if stage != 'production' and not allow_queue_job_dev:
            return self
