...
from wagtail.admin.panels import MultiFieldPanel, FieldPanel, FieldRowPanel, StreamFieldPanel
...
class Navbar(models.Model):
    ...
    navbar_links = StreamField([('links', LinkBlock())], blank=True,
                               help_text='Navbar navigation links (Uses Parent Page if blank)',use_json_field=False)
    sidebar_links = StreamField([('links', LinkBlock())], blank=True,
                                help_text="Sidebar navigation links (Uses Navbar links if blank).",use_json_field=False)
...
class Footer(models.Model):
    ...
    footer_items = StreamField(get_footer_blocks(), blank=True,use_json_field=False)
    footer_copyright = StreamField(get_footer_blocks(), blank=True,use_json_field=False)
