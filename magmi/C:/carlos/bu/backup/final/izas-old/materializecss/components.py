...
class LinkBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        template = 'material/components/link_block.html'
        label = _('Link')
...
class Badge(blocks.StructBlock):
    ...
    class Meta:
        label = _('Badge')
        template = 'material/components/badge.html'
...
class Button(LinkBlock):
    ...
    class Meta:
        ...
        value_class = LinkStructValue
        label = _('Button')
        template = 'material/components/button.html'
...
class FAB(blocks.StructBlock):
    ...
    class Meta:
        icon = 'plus-inverse'
        value_class = LinkStructValue
        template = 'material/components/fab.html'
...
class Breadcrumb(blocks.ListBlock):
    ...
    class Meta:
        label = _('Breadcrumb')
        template = 'material/components/breadcrumb.html'
...
class Card(blocks.StructBlock):
    ...
    class Meta:
        label = _('Card')
        template = 'material/components/card.html'
...
class CollectionItem(blocks.StructBlock):
    ...
    class Meta:
        ...
        icon = 'list-ul'
        template = 'material/components/collection_item.html'
...
class CollectionLink(CollectionItem):
    ...
    class Meta:
        ...
        icon = 'link'
        value_class = LinkStructValue
        template = 'material/components/collection_link.html'
...
class CollectionHeader(CollectionItem):
    ...
    class Meta:
        ...
        icon = 'title'
        template = 'material/components/collection_header.html'
...
class CollectionAvatar(blocks.StructBlock):
    ...
    class Meta:
        ...
        icon = 'user'
        template = 'material/components/collection_avatar.html'
...
class Collection(blocks.StreamBlock):
    ...
    class Meta:
        ...
        template = 'material/components/collection.html'
...
class Icon(blocks.CharBlock):
    ...
    class Meta:
        label = _('Icon')
        template = 'material/components/icon.html'
...
class Preloader(blocks.StructBlock):
    ...
    class Meta:
        ...
        template = 'material/components/preloader.html'
