...
from .validators import hex_triplet_validator
...
from .validators import color_hex_validator, color_hexa_validator
from .widgets import BigColorWidget
