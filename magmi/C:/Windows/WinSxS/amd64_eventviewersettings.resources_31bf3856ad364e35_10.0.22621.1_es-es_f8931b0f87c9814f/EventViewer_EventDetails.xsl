...
<xsl:variable name="WordsFormat">En palabras</xsl:variable>

<!-- _locID_text="BytesFormat" -->
<xsl:variable name="BytesFormat">En bytes</xsl:variable>
...
<xsl:when test="descendant::*[contains(local-name(), 'Binary')]">
  ...
  <xsl:variable name="BinaryDataCaption">Datos binarios:</xsl:variable>
